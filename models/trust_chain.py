...
class TrustCertificate:
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "subject_pub": _b64_encode(self.subject_pub),
            "issuer_name": self.issuer_name,
            "issuer_pub": _b64_encode(self.issuer_pub),
            "cert_type": self.cert_type.value,
            "not_before": self.not_before,
            "not_after": self.not_after,
            "signature": _b64_encode(self.signature),
    ...
    def from_dict(cls, d: Dict[str, Any]) -> TrustCertificate:
        ...
        return cls(
            ...
            subject_pub=_b64_decode(d["subject_pub"]),
            issuer_name=d["issuer_name"],
            issuer_pub=_b64_decode(d["issuer_pub"]),
            cert_type=cert_type,
            not_before=float(d["not_before"]),
            not_after=float(d["not_after"]),
            signature=_b64_decode(d["signature"]),
